...
echo "======================debug output of env vars - start ========================"
echo ip stack: $IP_STACK
echo provisioning host external ip: $PROVISIONING_HOST_EXTERNAL_IP
echo external subnet ipv4: $EXTERNAL_SUBNET_V4
...
if [ "${IP_STACK}" = "v4" ]; then
	...
	SKIP="$SKIP|IPV6|IPV4|L2|ConfigurationState|IP Assignment|Webhooks|Multiprotocol"
	export PROVISIONING_HOST_EXTERNAL_IPV4=${PROVISIONING_HOST_EXTERNAL_IP}
